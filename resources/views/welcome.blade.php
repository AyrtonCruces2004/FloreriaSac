...
{{-- Copilot: Genera una sección Hero responsive con Tailwind CSS
     ...
     - Dos columnas en desktop (stack en mobile)
       • Izquierda: 
         – h1 “Bienvenido a Nuestra Florería” (text-4xl font-bold text-white)
         – p descriptivo (text-lg text-gray-200)
         – botón “Ver Catálogo” (px-6 py-3 bg-black text-white rounded-lg hover:bg-gray-900)
       • Derecha:
         – Carrusel de imágenes (usa Swiper.js o Alpine.js + CSS transition)
         – Cada slide ocupa todo el espacio, altura fija, imágenes cover rounded-md
     – Añade paginación o flechas de navegación sobre el carrusel
--}}
